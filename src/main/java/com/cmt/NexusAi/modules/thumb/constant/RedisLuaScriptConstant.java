package com.cmt.NexusAi.modules.thumb.constant;
...
public class RedisLuaScriptConstant {
     ...
     * -1: 已点赞
     * 1: 操作成功
     * 临时技术键中存储的 hash 键格式为：{userId}:{blogId} value 为 点赞总数
     * 用户点赞状态键中存储的 hash 键格式为：{userId}:{blogId} value 为 1 或者 -1 lua脚本中带去重
     */
