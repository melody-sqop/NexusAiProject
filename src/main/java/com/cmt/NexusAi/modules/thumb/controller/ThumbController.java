package com.cmt.NexusAi.modules.thumb.controller;
...
public class ThumbController {
    ...
    @PostMapping("/do")
    public BaseResponse<Boolean> doThumb(@RequestBody DoThumbRequestDTO doThumbRequest, HttpServletRequest request) {
        Boolean success = thumbService.doThumb(doThumbRequest, request);
        return ResultUtils.success(success);
    }

    @PostMapping("/undo")
    public BaseResponse<Boolean> undoThumb(@RequestBody DoThumbRequestDTO doThumbRequest, HttpServletRequest request) {
