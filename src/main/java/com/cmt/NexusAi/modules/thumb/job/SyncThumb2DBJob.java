package com.cmt.NexusAi.modules.thumb.job;
...
import com.cmt.NexusAi.modules.thumb.enums.ThumbTypeEnum;
import com.cmt.NexusAi.modules.thumb.service.ThumbService;
import com.cmt.NexusAi.modules.thumb.util.RedisKeyUtil;
...
//    @Scheduled(fixedRate = 10000)
    ...
    public void syncThumb2DBByDate(String date) {
        // 利用时间骗 获取到临时点赞和取消点赞数据的 userId 和 blogId
        ...
        // allTempThumbMap.keySet()中的key为 userId:blogId 而value则为点赞总数
